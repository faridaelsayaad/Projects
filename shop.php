                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <form action="hello.php">
                                <div class="input-group">
                                    <input  type="text" name=search class="form-control" placeholder="Search by name"onkeyup="searchuser(this.value)"><br>
    <div id="myresult"></div>>
...
// document.getElementById("myresult").innerHTML=str;
 ...
 xmlhttp.open("GET","searchAdAjaxShop.php?query="+str,true);
 xmlhttp.send();
